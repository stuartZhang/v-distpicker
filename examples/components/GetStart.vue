<template>
  <div class="row">
    <div class="blocks">
      ...
      <div class="block">
        <h5>Installation</h5>
        <pre class="language-shell code-toolbar"><code class=" language-shell">npm install v-distpicker-stzhang --save</code></pre>
        <p>Or</p>
        <pre class="language-shell code-toolbar"><code class=" language-shell">yarn add v-distpicker-stzhang --save</code></pre>
      </div>
      <div class="block">
        <h5>Register global component</h5>
          <pre class=" language-javascript code-toolbar"><code class=" language-javascript"><span class="token keyword">import</span> VDistpicker <span class="token keyword">from</span> <span class="token string">'v-distpicker-stzhang'</span>
